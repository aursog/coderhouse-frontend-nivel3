...
app.controller('MainCtrl', [
  "$scope", "listaProductos", "$log", "CONS", "valor", "providerNombre",
  function ($scope, listaProductos, $log, CONS, valor, providerNombre) {
    $log.debug(CONS);
    $log.debug(valor);

    $log.debug(providerNombre.data.getManuales());
    //$log.debug(providerNombre.nuevoManual("la piedra"));
    ...
    $scope.urlimage = "images/yeoman.png";
